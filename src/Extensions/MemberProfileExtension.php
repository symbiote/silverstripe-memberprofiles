...
class MemberProfileExtension extends DataExtension
{
    ...
    {
        if($this->owner->NeedsApproval) $result->error(
            _t(
        ...
        if($this->owner->NeedsValidation) $result->error(
            _t(
