...
class MemberProfilePage extends Page implements PermissionProvider
{
    ...
    public function getCMSFields() 
    {
        ...
        $grid->getComponentByType(GridFieldDataColumns::class)->setFieldFormatting(
            array(
        ...
        if(!$this->AllowProfileViewing) {
            $disabledNote = new LiteralField(
                'PublisProfileDisabledNote', sprintf(
        ...
        foreach($contentFields as $type) {
            $fields->addFieldToTab(
                "Root.ContentBlocks", new ToggleCompositeField(
                    "{$type}Toggle",
        ...
        $fields->addFieldsToTab(
            ...
            new ToggleCompositeField(
                'EmailContentToggle',  _t('MemberProfiles.EMAILCONTENT', 'Email Content'), array(
            ...
            new ToggleCompositeField(
                'ConfirmationContentToggle', _t('MemberProfiles.CONFIRMCONTENT', 'Confirmation Content'), array(
